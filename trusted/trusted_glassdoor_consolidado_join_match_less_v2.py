...
table_name = 'public.raw_glassdoor_consolidado_join_match_less_v2'  
...
parquet_file = os.path.join(output_dir, 'trusted_glassdoor_consolidado_join_match_less_v2') #nome do arquivo
...
new_table_name = 'trusted_glassdoor_consolidado_join_match_less_v2'
